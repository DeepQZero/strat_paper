...
def load_experiment():
    path = r"C:\Users\Kyler\Desktop\GitHub\strat_paper\section_4\exp_4_5_dense_strat\tb_logs\exp_4_5_logs\PPO_1"
...
def main():
    ...
    plot_data(train_data, "4_5_fig_1.png", "Mean Training Reward", "Stratified PPO Training Data with Dense Rewards")
    plot_data(eval_data, "4_5_fig_2.png", "Mean Eval Reward", "PPO Evaluation Data With Dense Rewards")
    return
