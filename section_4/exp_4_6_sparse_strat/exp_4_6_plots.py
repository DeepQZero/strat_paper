...
def main():
    ...
    plot_data(train_data, "4_6_fig_1.png", "Mean Training Reward", "Stratified PPO Training Data with Sparse Rewards")
    plot_data(eval_data, "4_6_fig_2.png", "Mean Eval Reward", "PPO Evaluation Data With Sparse Rewards")
    return
